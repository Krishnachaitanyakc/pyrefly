...
testcase!(
    test_unpack_non_typed_dict_in_kwargs,
    r#"
from typing import Unpack

def func1(**kwargs: Unpack[int]):  # E: `Unpack` in **kwargs annotation must be used with a `TypedDict`
    pass

def func2(**kwargs: Unpack[str]):  # E: `Unpack` in **kwargs annotation must be used with a `TypedDict`
    pass

def func3(**kwargs: Unpack[list[int]]):  # E: `Unpack` in **kwargs annotation must be used with a `TypedDict`
    pass

def func4(**kwargs: Unpack[dict[str, int]]):  # E: `Unpack` in **kwargs annotation must be used with a `TypedDict`
    pass
    "#,
);
